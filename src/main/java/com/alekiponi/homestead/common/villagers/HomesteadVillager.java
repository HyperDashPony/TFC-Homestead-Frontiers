...
public class HomesteadVillager extends Villager {
    public HomesteadVillager(EntityType<? extends HomesteadVillager> tfcHomesteadVillagerEntityType, Level level) {
    ...
    public Villager getBreedOffspring(ServerLevel level, AgeableMob mob) {
        Villager villager = new HomesteadVillager(HomesteadEntities.VILLAGER.get(), level);
