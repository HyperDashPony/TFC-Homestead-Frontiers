...
public class HomesteadTrades {
    ...
    static {
        ...
        register(HomesteadVillagerProfessions.LUMBERJACK.get(), 10, HomesteadTrades::getLogOffer);
        register(HomesteadVillagerProfessions.LUMBERJACK.get(), 10, HomesteadTrades::getLeavesOffer);
        register(HomesteadVillagerProfessions.LUMBERJACK.get(), 10, HomesteadTrades::getPlankOffer);
        register(HomesteadVillagerProfessions.FARMER.get(), 4, HomesteadTrades::getCropOffer);
        register(HomesteadVillagerProfessions.FARMER.get(), 4, HomesteadTrades::getFruitOffer);
        register(HomesteadVillagerProfessions.FARMER.get(), 1, HomesteadTrades::getNutrientOffer);
